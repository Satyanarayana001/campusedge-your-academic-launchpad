      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-display font-bold text-foreground">CampusEdge</h1>
          </div>
          <p className="text-muted-foreground">Your academic life, supercharged</p>
        </div>
        ...
        <div className="glass-card-elevated rounded-2xl p-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-border bg-card hover:bg-muted transition-colors text-foreground font-medium text-sm mb-4"
          >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl gradient-accent text-accent-foreground font-medium text-sm transition-transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
            >
